...
const client = z.object({
  ...
  MAXIMUM_SPEECH_RECOGNITION_DURATION: z.string(),
  NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY: z.string(),
});
...
const processEnv = {
  ...
  DEFAULT_NUMBER_OF_QUESTIONS: process.env.DEFAULT_NUMBER_OF_QUESTIONS,
  MAXIMUM_SPEECH_RECOGNITION_DURATION:
    process.env.MAXIMUM_SPEECH_RECOGNITION_DURATION,
